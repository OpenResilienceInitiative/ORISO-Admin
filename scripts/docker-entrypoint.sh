...
MEDIA_AI_SCAN_AVAILABLE=$(pick VITE_MEDIA_AI_SCAN_AVAILABLE REACT_APP_MEDIA_AI_SCAN_AVAILABLE || true)
...

{
    ...
    emit_config_value "MEDIA_AI_SCAN_AVAILABLE" "$MEDIA_AI_SCAN_AVAILABLE"
