 ...
 * at the end of a successful registration. Now it uses the shared status
 * colours for the confirmation, states the two facts that actually matter
 * separately, shows the assigned ID as a labelled detail, and its single
 * primary action is the shared M3 button.
 */
export const DoneStep = ({ tenantId }: DoneStepProps) => {
    ...
    return (
        <div className={styles.done} data-testid="onboarding-done">
            <CheckCircleRounded className={styles.doneIcon} data-testid="onboarding-done-success-icon" aria-hidden />
