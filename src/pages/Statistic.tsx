...
const caseChartDays = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
...
const demoConversationByScope: Record<ScopeKey, Record<ConversationPeriodKey, ConversationPeriodData>> = {
    platform: {
        today: createConversationData([3, 2, 1, 1]),
        yesterday: createConversationData([2, 2, 1, 0]),
        thisWeek: createConversationData([9, 5, 3, 2]),
        total: createConversationData([14, 8, 4, 4]),
        thisYear: createConversationData([12, 7, 3, 4]),
        lastYear: createConversationData([10, 6, 3, 3]),
    },
    tenant: {
        today: createConversationData([2, 1, 1, 1]),
        yesterday: createConversationData([1, 1, 1, 1]),
        thisWeek: createConversationData([5, 4, 2, 2]),
        total: createConversationData([8, 5, 3, 2]),
        thisYear: createConversationData([7, 4, 2, 2]),
        lastYear: createConversationData([6, 4, 2, 1]),
    },
    agency: {
        today: createConversationData([1, 1, 1, 0]),
        yesterday: createConversationData([1, 0, 1, 0]),
        thisWeek: createConversationData([3, 2, 1, 1]),
        total: createConversationData([4, 2, 1, 1]),
        thisYear: createConversationData([3, 2, 1, 1]),
        lastYear: createConversationData([3, 1, 1, 1]),
    },
};
...
const dashboardByScope: Record<ScopeKey, ScopeDashboard> = {
    platform: {
        ...
        caseCharts: {
            thisWeek: [
                { day: 'Mon', dateLabel: 'Mo, 9 Jul', value: 1900 },
                { day: 'Tue', dateLabel: 'Di, 10 Jul', value: 2250 },
                { day: 'Wed', dateLabel: 'Mi, 11 Jul', value: 2250 },
                { day: 'Thu', dateLabel: 'Do, 12 Jul', value: 3150, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 13 Jul', value: 2250 },
                { day: 'Sat', dateLabel: 'Sa, 14 Jul', value: 2250 },
                { day: 'Sun', dateLabel: 'So, 15 Jul', value: 2250 },
            ],
            lastWeek: [
                { day: 'Mon', dateLabel: 'Mo, 2 Jul', value: 1680 },
                { day: 'Tue', dateLabel: 'Di, 3 Jul', value: 2040 },
                { day: 'Wed', dateLabel: 'Mi, 4 Jul', value: 2180 },
                { day: 'Thu', dateLabel: 'Do, 5 Jul', value: 2460, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 6 Jul', value: 2360 },
                { day: 'Sat', dateLabel: 'Sa, 7 Jul', value: 1880 },
                { day: 'Sun', dateLabel: 'So, 8 Jul', value: 1720 },
            ],
            twoWeeksAgo: [
                { day: 'Mon', dateLabel: 'Mo, 25 Jun', value: 1420 },
                { day: 'Tue', dateLabel: 'Di, 26 Jun', value: 1780 },
                { day: 'Wed', dateLabel: 'Mi, 27 Jun', value: 1960 },
                { day: 'Thu', dateLabel: 'Do, 28 Jun', value: 2210, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 29 Jun', value: 2060 },
                { day: 'Sat', dateLabel: 'Sa, 30 Jun', value: 1640 },
                { day: 'Sun', dateLabel: 'So, 1 Jul', value: 1510 },
            ],
            threeWeeksAgo: [
                { day: 'Mon', dateLabel: 'Mo, 18 Jun', value: 1320 },
                { day: 'Tue', dateLabel: 'Di, 19 Jun', value: 1650 },
                { day: 'Wed', dateLabel: 'Mi, 20 Jun', value: 1840 },
                { day: 'Thu', dateLabel: 'Do, 21 Jun', value: 2080, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 22 Jun', value: 1920 },
                { day: 'Sat', dateLabel: 'Sa, 23 Jun', value: 1520 },
                { day: 'Sun', dateLabel: 'So, 24 Jun', value: 1390 },
            ],
            fourWeeksAgo: [
                { day: 'Mon', dateLabel: 'Mo, 11 Jun', value: 1210 },
                { day: 'Tue', dateLabel: 'Di, 12 Jun', value: 1540 },
                { day: 'Wed', dateLabel: 'Mi, 13 Jun', value: 1710 },
                { day: 'Thu', dateLabel: 'Do, 14 Jun', value: 1940, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 15 Jun', value: 1810 },
                { day: 'Sat', dateLabel: 'Sa, 16 Jun', value: 1430 },
                { day: 'Sun', dateLabel: 'So, 17 Jun', value: 1280 },
            ],
        },
        conversation: {
            today: {
    ...
    tenant: {
        ...
        caseCharts: {
            thisWeek: [
                { day: 'Mon', dateLabel: 'Mo, 9 Jul', value: 820 },
                { day: 'Tue', dateLabel: 'Di, 10 Jul', value: 1180 },
                { day: 'Wed', dateLabel: 'Mi, 11 Jul', value: 960 },
                { day: 'Thu', dateLabel: 'Do, 12 Jul', value: 1520, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 13 Jul', value: 1220 },
                { day: 'Sat', dateLabel: 'Sa, 14 Jul', value: 870 },
                { day: 'Sun', dateLabel: 'So, 15 Jul', value: 760 },
            ],
            lastWeek: [
                { day: 'Mon', dateLabel: 'Mo, 2 Jul', value: 690 },
                { day: 'Tue', dateLabel: 'Di, 3 Jul', value: 1040 },
                { day: 'Wed', dateLabel: 'Mi, 4 Jul', value: 910 },
                { day: 'Thu', dateLabel: 'Do, 5 Jul', value: 1280, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 6 Jul', value: 1160 },
                { day: 'Sat', dateLabel: 'Sa, 7 Jul', value: 820 },
                { day: 'Sun', dateLabel: 'So, 8 Jul', value: 710 },
            ],
            twoWeeksAgo: [
                { day: 'Mon', dateLabel: 'Mo, 25 Jun', value: 610 },
                { day: 'Tue', dateLabel: 'Di, 26 Jun', value: 880 },
                { day: 'Wed', dateLabel: 'Mi, 27 Jun', value: 830 },
                { day: 'Thu', dateLabel: 'Do, 28 Jun', value: 1090, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 29 Jun', value: 970 },
                { day: 'Sat', dateLabel: 'Sa, 30 Jun', value: 690 },
                { day: 'Sun', dateLabel: 'So, 1 Jul', value: 640 },
            ],
            threeWeeksAgo: [
                { day: 'Mon', dateLabel: 'Mo, 18 Jun', value: 560 },
                { day: 'Tue', dateLabel: 'Di, 19 Jun', value: 820 },
                { day: 'Wed', dateLabel: 'Mi, 20 Jun', value: 760 },
                { day: 'Thu', dateLabel: 'Do, 21 Jun', value: 1010, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 22 Jun', value: 900 },
                { day: 'Sat', dateLabel: 'Sa, 23 Jun', value: 650 },
                { day: 'Sun', dateLabel: 'So, 24 Jun', value: 590 },
            ],
            fourWeeksAgo: [
                { day: 'Mon', dateLabel: 'Mo, 11 Jun', value: 520 },
                { day: 'Tue', dateLabel: 'Di, 12 Jun', value: 760 },
                { day: 'Wed', dateLabel: 'Mi, 13 Jun', value: 710 },
                { day: 'Thu', dateLabel: 'Do, 14 Jun', value: 940, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 15 Jun', value: 840 },
                { day: 'Sat', dateLabel: 'Sa, 16 Jun', value: 610 },
                { day: 'Sun', dateLabel: 'So, 17 Jun', value: 550 },
            ],
        },
        conversation: {
            today: {
    ...
    agency: {
        ...
        caseCharts: {
            thisWeek: [
                { day: 'Mon', dateLabel: 'Mo, 9 Jul', value: 420 },
                { day: 'Tue', dateLabel: 'Di, 10 Jul', value: 520 },
                { day: 'Wed', dateLabel: 'Mi, 11 Jul', value: 470 },
                { day: 'Thu', dateLabel: 'Do, 12 Jul', value: 690, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 13 Jul', value: 610 },
                { day: 'Sat', dateLabel: 'Sa, 14 Jul', value: 430 },
                { day: 'Sun', dateLabel: 'So, 15 Jul', value: 390 },
            ],
            lastWeek: [
                { day: 'Mon', dateLabel: 'Mo, 2 Jul', value: 360 },
                { day: 'Tue', dateLabel: 'Di, 3 Jul', value: 480 },
                { day: 'Wed', dateLabel: 'Mi, 4 Jul', value: 430 },
                { day: 'Thu', dateLabel: 'Do, 5 Jul', value: 590, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 6 Jul', value: 540 },
                { day: 'Sat', dateLabel: 'Sa, 7 Jul', value: 380 },
                { day: 'Sun', dateLabel: 'So, 8 Jul', value: 340 },
            ],
            twoWeeksAgo: [
                { day: 'Mon', dateLabel: 'Mo, 25 Jun', value: 310 },
                { day: 'Tue', dateLabel: 'Di, 26 Jun', value: 410 },
                { day: 'Wed', dateLabel: 'Mi, 27 Jun', value: 390 },
                { day: 'Thu', dateLabel: 'Do, 28 Jun', value: 520, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 29 Jun', value: 470 },
                { day: 'Sat', dateLabel: 'Sa, 30 Jun', value: 330 },
                { day: 'Sun', dateLabel: 'So, 1 Jul', value: 300 },
            ],
            threeWeeksAgo: [
                { day: 'Mon', dateLabel: 'Mo, 18 Jun', value: 290 },
                { day: 'Tue', dateLabel: 'Di, 19 Jun', value: 380 },
                { day: 'Wed', dateLabel: 'Mi, 20 Jun', value: 360 },
                { day: 'Thu', dateLabel: 'Do, 21 Jun', value: 480, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 22 Jun', value: 430 },
                { day: 'Sat', dateLabel: 'Sa, 23 Jun', value: 310 },
                { day: 'Sun', dateLabel: 'So, 24 Jun', value: 280 },
            ],
            fourWeeksAgo: [
                { day: 'Mon', dateLabel: 'Mo, 11 Jun', value: 260 },
                { day: 'Tue', dateLabel: 'Di, 12 Jun', value: 350 },
                { day: 'Wed', dateLabel: 'Mi, 13 Jun', value: 330 },
                { day: 'Thu', dateLabel: 'Do, 14 Jun', value: 440, isDefaultSelected: true },
                { day: 'Fri', dateLabel: 'Fr, 15 Jun', value: 400 },
                { day: 'Sat', dateLabel: 'Sa, 16 Jun', value: 290 },
                { day: 'Sun', dateLabel: 'So, 17 Jun', value: 260 },
            ],
        },
        conversation: {
            today: {
...
const getEffectiveIconTone = (icon: SvgIcon, tone?: IconTone) => {
    ...
    if ((icon === ConversationsIcon || icon === TextMessagesIcon) && tone === 'muted') {
        return undefined;
    }
                                ...
                                <div className="statisticDashboard__barStage">
                                    ...
                                    <div className="statisticDashboard__bars">
                                        {caseChart.map((bar, index) => {
                                            ...
                                            const tooltipStyle = {
                                                '--statistic-dashboard-tooltip-bottom': `calc(${height}% + 18px)`,
                                            } as CSSProperties;
