...
export const initWebVitalsMeterProvider = (): void => {
    ...
    if (!runtimeConfig.observabilityEnabled || !runtimeConfig.otelMetricsUrl) {
        return;
    }
    ...
    try {
        ...
        const metricReader = new PeriodicExportingMetricReader({
            exporter: new OTLPMetricExporter({
                url: runtimeConfig.otelMetricsUrl,
            }),
            exportIntervalMillis: runtimeConfig.otelExportIntervalMillis,
        });
