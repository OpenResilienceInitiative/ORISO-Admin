...
const GREY_ICON_FILL = 'var(--m3-surface-container-highest, #E4E2E2)';
...
const switchIcon = (checked: boolean, disabled: boolean) => {
    if (!checked) {
        return <OffIcon />;
    }
    if (disabled) {
