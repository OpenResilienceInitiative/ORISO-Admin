...
import { ReactComponent as SendTemplate } from '../../resources/img/svg/oriso/send_400_24px.svg';
...
export const SendTemplateIcon = (props: EditorIconProps) => (
    <Icon component={SendTemplate} {...decorative} {...props} />
);
