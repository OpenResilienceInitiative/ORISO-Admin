...
export const InputText: Story = {
    render: () => <FiveStateMatrix config={{ variant: 'filled', label: 'Label', value: 'Input text' }} />,
    play: focusPlay,
};
...
export const PlaceholderText: Story = {
    render: () => <FiveStateMatrix config={{ variant: 'filled', label: 'Label', placeholder: 'Placeholder' }} />,
    play: focusPlay,
};
